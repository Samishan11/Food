...
import {
  ProtectedRoutes,
  ProtectedAdmin,
} from "./components/protectedroutes/Protected";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            exact
            path="/food/:food"
            element={<Fooddetail userdata={userdata}></Fooddetail>}
          ></Route>
          <Route
            exact
            path="/search/:search"
            element={<Searchfood userdata={userdata}></Searchfood>}
          ></Route>
          ...
          <Route
            exact
            path="/contact"
            element={<Contact userdata={userdata}></Contact>}
          ></Route>
