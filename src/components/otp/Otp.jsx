      ...
      <div style={{ marginTop: "100px" }} className="container">
        <div className="d-flex justify-content-center align-items-center container">
          <div className="card py-5 px-3">
            <h5 className="m-0 h4">OPT verification</h5>
            ...
            <form id="create-course-form" onSubmit={verifyOtp}>
              <div className="d-flex flex-row mt-5">
                <input
                  id="opt1"
                  onChange={(e) => setOtp0(e.target.value)}
                  type="text"
                  className="form-control otp1"
                  autofocus
                />
                <input
                  id="opt2"
              ...
              <button
                type="submit"
                className="btn btn-outline-warning my-2 d-block mx-auto"
              >
                Verify
              </button>
            </form>
