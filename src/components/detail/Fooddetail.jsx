          ...
          <div className="col-md-6 col-12">
            <form>
              <div className="f-name ">
                ...
                <p className="fw-bold" style={{ fontSize: "5rem" }}>
                  {Food.name}
                </p>
                <span className="sideline"></span>
              </div>
              <div className="f-detail">
                <ReactStars
                  ...
                  activeColor="#ffd700"
                />
                <p style={{ fontSize: "1.2rem" }} className="pr-5 my-3 fw-bold">
                  {Food.description}
                </p>
              </div>
              <div className="f-price">
                <p className="fw-bold" style={{ fontSize: "1.6rem" }}>
                  Rs. {Food.price}
                </p>
              </div>
              <div className="size my-3">
                <h1 className="fw-bold" style={{ fontSize: "1.6rem" }}>
                  Choose the size
                </h1>
                <div className="item-size my-3 d-flex">
                  <div className="form-check">
                    ...
                    <label
                      style={{ fontSize: ".8rem" }}
                      className="fw-bold mx-1 form-check-label my-auto"
              ...
              <div className="addtocart my-3 d-flex">
                ...
                <button
                  ...
                  style={{ fontSize: ".8rem" }}
                  type="button"
                  className="mx-2 text-white fw-bold bg-warning  px-4"
                >
                  Add to cart
                </button>
              </div>
