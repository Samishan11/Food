  ...
  return (
    <div className="container my-5 mx-2">
      <div className="text-food text-center">
        ...
        <p style={{ fontSize: "1rem", color: "darkgray" }}>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed
          necessitatibus expedita, <br /> nisi dolor incidunt adipisci at. Ipsum
          perspiciatis fugit porro, expedita quisquam illo voluptas?
        </p>
      </div>
